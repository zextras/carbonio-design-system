...
const DefaultFontStyles = css`
	...
	@font-face {
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto300Eot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto300Woff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto300Woff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto300Ttf}) format('truetype'),
			/* Legacy iOS */ url('${roboto300Svg}#Roboto') format('svg');
	}
	...
	@font-face {
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto300ItalicEot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto300ItalicWoff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto300ItalicWoff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto300ItalicTtf}) format('truetype'),
			/* Legacy iOS */ url('${roboto300ItalicSvg}#Roboto') format('svg');
	}
	...
	@font-face {
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto400Eot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto400Woff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto400Woff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto400Ttf}) format('truetype'),
			/* Legacy iOS */ url('${roboto400Svg}#Roboto') format('svg');
	}
	/* roboto-italic - latin */
	@font-face {
		font-family: 'Roboto';
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto400ItalicEot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto400ItalicWoff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto400ItalicWoff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto400ItalicTtf}) format('truetype'),
			/* Legacy iOS */ url('${roboto400ItalicSvg}#Roboto') format('svg');
	}
	...
	@font-face {
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto500ItalicEot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto500ItalicWoff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto500ItalicWoff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto500ItalicTtf}) format('truetype'),
			/* Legacy iOS */ url('${roboto500ItalicSvg}#Roboto') format('svg');
	}
	/* roboto-500 - latin */
	@font-face {
		font-family: 'Roboto';
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto500Eot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto500Woff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto500Woff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto500Ttf}) format('truetype'),
			/* Legacy iOS */ url('${roboto500Svg}#Roboto') format('svg');
	}
	...
	@font-face {
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto700ItalicEot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto700ItalicWoff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto700ItalicWoff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto700ItalicTtf}) format('truetype'),
			/* Legacy iOS */ url('${roboto700ItalicSvg}#Roboto') format('svg');
	}
	/* roboto-700 - latin */
	@font-face {
		font-family: 'Roboto';
		...
		src:
			local(''),
			/* IE6-IE8 */ url('${roboto700Eot}?#iefix') format('embedded-opentype'),
			/* Super Modern Browsers */ url(${roboto700Woff2}) format('woff2'),
			/* Modern Browsers */ url(${roboto700Woff}) format('woff'),
			/* Safari, Android, iOS */ url(${roboto700Ttf}) format('truetype'),
			/* Legacy iOS */ url('${roboto700Svg}#Roboto') format('svg');
	}
`;
