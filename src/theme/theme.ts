...
export const Theme: ThemeObj = {
	...
	sizes: {
		font: { extrasmall: '8px', small: '12px', medium: '16px', large: '18px', extralarge: '20px' },
		icon: { extrasmall: '8px', small: '12px', medium: '16px', large: '18px', extralarge: '20px' },
		avatar: {
