...
import type { TableProps, THeader, TRow } from './Table';
...
export const WithoutCheckboxes = (args: TableProps): React.JSX.Element => (
	<Table
		{...args}
		rows={rows}
		headers={headers}
		showCheckbox={false}
		onSelectionChange={(selected): void => console.log('Uncontrolled selection onChange', selected)}
	/>
);
