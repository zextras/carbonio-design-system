...
- ChipInput loses the focus (onBlur)
...
## onAdd vs onChange
**onAdd** and **onChange** have two different meanings in the chip input:
...
When options are provided, and there is some option in the dropdown, the blur event does not create a chip.
