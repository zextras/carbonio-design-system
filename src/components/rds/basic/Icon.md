...
<Container orientation="horizontal" mainAlignment="space-around">
    <Icon icon={BackUpLogo} size="extrasmall" color="primary" />
    <Icon icon={BackUpLogo} size="small" color="secondary" />
    <Icon icon={BackUpLogo} size="medium" color="text" />
    <Icon icon={BackUpLogo} size="large" color="error" />
    <Icon icon={BackUpLogo} size="extralarge" color="success" />
</Container>
```
