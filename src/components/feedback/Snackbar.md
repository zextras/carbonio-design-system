...
<>
    ...
    <Snackbar key="s1" open={snack1} onClose={closeSnack1} severity="success" label="Lorem Ipsum dolor sit amet" />
    <Snackbar key="s2" open={snack2} onClose={closeSnack2} severity="info" label="Lorem Ipsum dolor sit amet" />
    <Snackbar key="s3" open={snack3} onClose={closeSnack3} severity="warning" label="Lorem Ipsum dolor sit amet" />
    <Snackbar key="s4" open={snack4} onClose={closeSnack4} severity="error" label="Lorem Ipsum dolor sit amet" disableAutoHide />
    <Snackbar key="s5" open={snack5} onClose={closeSnack5} severity="info" label="Файл был перемещен в корзину" actionLabel="Откройте папку корзины"  disableAutoHide />
    <Snackbar key="s6" open={snack6} onClose={closeSnack6} severity="info" label="Text" actionLabel="Very long action on snackbar with superlongwordwithlotofchars"  disableAutoHide />
    <Snackbar key="s7" open={snack7} onClose={closeSnack7} severity="info" label="Very long action on snackbar with superlongwordwithlotofchars" actionLabel="Text"  disableAutoHide />
    <Snackbar key="s8" open={snack8} onClose={closeSnack8} severity="info" label="Item moved to trash with success" actionLabel="Go to trash folder"  disableAutoHide />
</>
```
