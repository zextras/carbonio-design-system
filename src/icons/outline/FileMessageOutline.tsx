...
const SvgFileMessageOutline = (props: SVGProps<SVGSVGElement>): React.JSX.Element => (
	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
		...
		<path d="M15.219 11.41H8.777c-.801 0-1.46.66-1.46 1.461v4.495c0 .8.659 1.46 1.46 1.46h6.442c.801 0 1.46-.66 1.46-1.46v-4.494c0-.802-.659-1.461-1.46-1.461m-.326.975-2.895 2.312-2.895-2.312zm.326 5.467H8.777a.49.49 0 0 1-.487-.486v-4.373l3.416 2.702a.49.49 0 0 0 .584 0l3.416-2.702v4.373a.49.49 0 0 1-.487.486" />
	</svg>
);
