...
const SvgConsoleOutline = (props: SVGProps<SVGSVGElement>): JSX.Element => (
	<svg width={24} height={24} xmlns="http://www.w3.org/2000/svg" {...props}>
		...
		<path d="M7.977 17.05a1 1 0 0 1-.71-1.709l1.409-1.32-1.257-1.34a1 1 0 1 1 1.419-1.409l1.936 2.03a1.003 1.003 0 0 1 0 1.399L8.676 16.73a1 1 0 0 1-.7.32Z" />
		<path
			fillRule="evenodd"
			clipRule="evenodd"
			d="M16.063 15.083a.984.984 0 0 1 0 1.967h-2.998a.984.984 0 0 1 0-1.967h2.998Z"
		/>
	</svg>
);
