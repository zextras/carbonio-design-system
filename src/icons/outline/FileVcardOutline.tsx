...
const SvgFileVcardOutline = (props: SVGProps<SVGSVGElement>): React.JSX.Element => (
	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
		...
		<path d="M14.59 18.889a.436.436 0 0 0 .434-.434 3.05 3.05 0 0 0-3.036-3.036 3.05 3.05 0 0 0-3.036 3.036c0 .238.196.434.434.434zm-2.602-4.337c.952 0 1.735-.783 1.735-1.735s-.783-1.735-1.735-1.735-1.735.783-1.735 1.735.783 1.735 1.735 1.735" />
	</svg>
);
