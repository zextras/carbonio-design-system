...
const SvgCosOutline = (props: SVGProps<SVGSVGElement>): React.JSX.Element => (
	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
		<path
			...
			clipRule="evenodd"
		/>
		<path d="M12 7c-2.743 0-5 2.257-5 5s2.257 5 5 5 5-2.257 5-5-2.257-5-5-5m0 8c-1.646 0-3-1.354-3-3s1.354-3 3-3 3 1.354 3 3-1.354 3-3 3" />
	</svg>
);
