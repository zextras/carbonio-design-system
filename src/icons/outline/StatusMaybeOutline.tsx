...
const SvgStatusMaybeOutline = (props: SVGProps<SVGSVGElement>): React.JSX.Element => (
	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
		...
		<path d="M12.008 17a1 1 0 1 1-.001 2 1 1 0 0 1 0-2m0-9.063c-1.92 0-3.5 1.58-3.5 3.5 0 .548.451 1 1 1s1-.452 1-1c0-.823.677-1.5 1.5-1.5s1.5.677 1.5 1.5c0 .822-.677 1.5-1.5 1.5-.549 0-1 .451-1 1v1.062c0 .549.451 1 1 1s1-.451 1-1v-.222a3.5 3.5 0 0 0 2.512-3.35 3.507 3.507 0 0 0-3.49-3.49z" />
	</svg>
);
