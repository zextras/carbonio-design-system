...
const SvgListViewOutline = (props: SVGProps<SVGSVGElement>): JSX.Element => (
	<svg width={24} height={24} xmlns="http://www.w3.org/2000/svg" {...props}>
		...
		<path
			fillRule="evenodd"
			clipRule="evenodd"
			d="M8.988 9.49a1 1 0 000 1.998h6a1 1 0 000-1.998h-6zM8.988 16.479a1 1 0 000 1.998h6a1 1 0 000-1.998h-6zM8.988 12.984a1 1 0 000 1.998h6a1 1 0 000-1.998h-6z"
		/>
	</svg>
);
